...
export default function SignUp() {
    return (
        <MobileContainer>
            ...
            <LoginForm>
                <StandartInput type="text" placeholder="Nome"/>
                <StandartInput type="number" placeholder="CPF"/>
                <StandartInput type="email" placeholder="E-mail"/>
                <StandartInput type="password" placeholder="Senha"/>
                <StandarButton>Cadastrar</StandarButton>
            </LoginForm>
            <LoginSignUpFooterText>Já possuí uma conta? Entre</LoginSignUpFooterText>
        </MobileContainer>
    );
}
